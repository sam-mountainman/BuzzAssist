...
const REQUIRED_REFERENCES = [
  { id: "linework-male", file: "koutani-style-linework-male-v2.png", role: "character-style", tags: ["male", "profile", "linework", "hair"] },
  { id: "linework-female", file: "koutani-style-linework-female-v2.png", role: "character-style", tags: ["female", "closeup", "linework", "face"] },
  { id: "group-composition", file: "koutani-style-group-composition-v2.png", role: "composition", tags: ["dialogue", "medium", "interior"] },
  { id: "action-prop", file: "koutani-style-action-prop-v2.png", role: "composition", tags: ["action", "hands", "prop", "interior"] },
  { id: "day-background", file: "koutani-style-day-background-v2.png", role: "background", tags: ["exterior", "day", "wide"] },
  { id: "night-background", file: "koutani-style-night-background-v2.png", role: "background", tags: ["exterior", "night", "wide"] },
  { id: "warm-interior", file: "koutani-style-warm-interior-v2.png", role: "background", tags: ["interior", "warm", "day"] },
  { id: "neutral-interior", file: "koutani-style-soft-interior-v2.png", role: "background", tags: ["interior", "neutral"] },
];
