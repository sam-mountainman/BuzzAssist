...
export async function handleVideoHarnessToolCall(params, {
  ...
  switch (params?.name) {
    ...
    case TOOL_RUN_VIDEO_HARNESS: {
      ...
      result = await service.start({ ...normalizeJobArguments(startArgs, env), invocation });
      break;
    }
