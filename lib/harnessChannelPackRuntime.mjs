...
const TOP_LEVEL_FIELDS = new Set(["version", "runtime", "image", "voice", "music", "render", "concurrency", "bookends"]);
...
const BOOKEND_FIELDS = new Set(["enabled"]);
...
function validateSourceConfigShape(source) {
  ...
  if (source.bookends !== undefined) assertAllowedFields(source.bookends, BOOKEND_FIELDS, "narrated-story.json.bookends");
}
