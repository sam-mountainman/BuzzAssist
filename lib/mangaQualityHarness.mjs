...
export const MANGA_QUALITY_HARNESS_VERSION = 3;
...
export function mergeMangaQualityIncidentLedgers(...ledgers) {
  const rank = { checklist: 1, instruction: 2, "hard-gate": 3 };
  ...
  for (const ledger of ledgers) {
    for (const incident of ledger?.incidents || []) {
      ...
      bySignature.set(signature, {
        ...previous,
        ...incident,
        occurrences: Math.max(finiteNumber(previous.occurrences, 0), finiteNumber(incident.occurrences, 0), 1),
