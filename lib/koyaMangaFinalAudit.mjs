...
import { finalizeRunReceipt, openRunReceipt, recordGatesFromAuditSteps, writeRunReceipt } from "./harnessRunReceipt.mjs";
...
export async function auditKoyaMangaFinal(options = {}) {
  ...
  try {
    ...
    const receipt = openRunReceipt({
      ...
      action: "audit",
      inputs: { videoSha256, contractDigest: resolvedContract.digest, manifestId: manifest.id },
    });
  ...
  return { reportPath, report, contactSheetPath, signoffPath, runReceiptPath };
}
