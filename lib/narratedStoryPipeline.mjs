 ...
 */
export async function inspectNarratedStoryPlan({ scriptPath, channelPackDir, operatorImageManifestPath = "", projectDir = "" } = {}) {
...
export async function runNarratedStoryPipeline({
  ...
  const outcome = await withPipelineLock(runDir, async () => {
    ...
    await writeAtomic(generationManifestPath, {
      ...
      ...narratedVisualManifestFields({ config, subtitleLayer, cameraPlan }),
