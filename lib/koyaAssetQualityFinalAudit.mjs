...
import { checkKoyaAssetQuality, koyaAssetQualityWorkDir } from "./koyaAssetQualityGate.mjs";
import {
...
export async function auditKoyaEpisodeAssetQuality({
  ...
  return {
    ...
    counts,
    detail: pass
      ? `passed（画 ${counts.sceneImages}・声 ${counts.voiceTakes}・人物/場所 ${counts.registryEntries}`
