...
export const LOVART_IMAGE_MODELS = [
  { id: "lovart-midjourney", label: "Midjourney (Lovart)", tool: "generate_image_midjourney" },
  { id: "lovart-flux-2-max", label: "Flux.2 Max (Lovart)", tool: "generate_image_flux_2_max" },
  { id: "lovart-nano-banana-pro", label: "Nano Banana Pro (Lovart)", tool: "generate_image_nano_banana_pro" },
  { id: "lovart-ideogram-v4", label: "Ideogram 4 (Lovart)", tool: "generate_image_ideogram_v4" },
  { id: "lovart-agent", label: "Lovart Agent (おまかせ)", tool: null },
];

export const LOVART_VIDEO_MODELS = [
  { id: "lovart-veo-3-1", label: "Veo 3.1 (Lovart)", tool: "generate_video_veo3_1" },
  { id: "lovart-veo-3-1-fast", label: "Veo 3.1 Fast (Lovart)", tool: "generate_video_veo3_1_fast" },
  { id: "lovart-hailuo-2-3", label: "Hailuo 2.3 (Lovart)", tool: "generate_video_hailuo_v2_3" },
  { id: "lovart-kling-3-omni", label: "Kling 3.0 Omni (Lovart)", tool: "generate_video_kling_v3_omni" },
  { id: "lovart-wan-2-6", label: "Wan 2.6 (Lovart)", tool: "generate_video_wan_v2_6" },
];
