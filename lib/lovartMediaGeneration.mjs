...
export const LOVART_IMAGE_MODELS = [
  { id: "lovart-agent", label: "Lovart Agent (おまかせ)", tool: null, provider: "lovart" },
  { id: "lovart-midjourney", label: "Midjourney", tool: "generate_image_midjourney", provider: "midjourney" },
  { id: "lovart-nano-banana-pro", label: "Nano Banana Pro", tool: "generate_image_nano_banana_pro", provider: "nano-banana" },
  { id: "lovart-nano-banana-2", label: "Nano Banana 2", tool: "generate_image_nano_banana_2", provider: "nano-banana" },
  { id: "lovart-nano-banana-2-lite", label: "Nano Banana 2 Lite", tool: "generate_image_nano_banana_2_lite", provider: "nano-banana" },
  { id: "lovart-nano-banana", label: "Nano Banana", tool: "generate_image_nano_banana", provider: "nano-banana" },
  { id: "lovart-gpt-image-2", label: "GPT Image 2", tool: "generate_image_gpt_image_2", provider: "openai" },
  { id: "lovart-gpt-image-2-low", label: "GPT Image 2 Low", tool: "generate_image_gpt_image_2_low", provider: "openai" },
  { id: "lovart-gpt-image-2-medium", label: "GPT Image 2 Medium", tool: "generate_image_gpt_image_2_medium", provider: "openai" },
  { id: "lovart-gpt-image-2-high", label: "GPT Image 2 High", tool: "generate_image_gpt_image_2_high", provider: "openai" },
  { id: "lovart-gpt-image-1-5", label: "GPT Image 1.5", tool: "generate_image_gpt_image_1_5", provider: "openai" },
  { id: "lovart-luma-uni-1", label: "Luma Uni-1", tool: "generate_image_luma_uni_1", provider: "luma" },
  { id: "lovart-luma-uni-1-max", label: "Luma Uni-1 Max", tool: "generate_image_luma_uni_1_max", provider: "luma" },
  { id: "lovart-flux-2-max", label: "Flux.2 Max", tool: "generate_image_flux_2_max", provider: "flux" },
  { id: "lovart-flux-2-pro", label: "Flux.2 Pro", tool: "generate_image_flux_2_pro", provider: "flux" },
  { id: "lovart-seedream-v5", label: "Seedream 5.0 Lite", tool: "generate_image_seedream_v5", provider: "seedream" },
  { id: "lovart-seedream-v4-5", label: "Seedream 4.5", tool: "generate_image_seedream_v4_5", provider: "seedream" },
  { id: "lovart-seedream-v4", label: "Seedream 4", tool: "generate_image_seedream_v4", provider: "seedream" },
  { id: "lovart-ideogram-v4", label: "Ideogram 4", tool: "generate_image_ideogram_v4", provider: "ideogram" },
];

export const LOVART_VIDEO_MODELS = [
  { id: "lovart-agent-video", label: "Lovart Agent (おまかせ)", tool: null, provider: "lovart" },
  { id: "lovart-veo-3-1", label: "Veo 3.1", tool: "generate_video_veo3_1", provider: "veo" },
  { id: "lovart-veo-3-1-fast", label: "Veo 3.1 Fast", tool: "generate_video_veo3_1_fast", provider: "veo" },
  { id: "lovart-veo-3", label: "Veo 3", tool: "generate_video_veo3", provider: "veo" },
  { id: "lovart-seedance-2", label: "Seedance 2.0", tool: "generate_video_seedance_v2_0", provider: "seedance" },
  { id: "lovart-seedance-2-fast", label: "Seedance 2.0 Fast", tool: "generate_video_seedance_v2_0_fast", provider: "seedance" },
  { id: "lovart-seedance-2-mini", label: "Seedance 2.0 Mini", tool: "generate_video_seedance_v2_0_mini", provider: "seedance" },
  { id: "lovart-seedance-pro-1-5", label: "Seedance 1.5 Pro", tool: "generate_video_seedance_pro_v1_5", provider: "seedance" },
  { id: "lovart-kling-v3", label: "Kling 3.0", tool: "generate_video_kling_v3", provider: "kling" },
  { id: "lovart-kling-3-omni", label: "Kling 3.0 Omni", tool: "generate_video_kling_v3_omni", provider: "kling" },
  { id: "lovart-kling-v2-6", label: "Kling 2.6", tool: "generate_video_kling_v2_6", provider: "kling" },
  { id: "lovart-kling-omni-v1", label: "Kling O1", tool: "generate_video_kling_omni_v1", provider: "kling" },
  { id: "lovart-hailuo-2-3", label: "Hailuo 2.3", tool: "generate_video_hailuo_v2_3", provider: "hailuo" },
  { id: "lovart-wan-2-6", label: "Wan 2.6", tool: "generate_video_wan_v2_6", provider: "wan" },
  { id: "lovart-vidu-q2", label: "Vidu Q2", tool: "generate_video_vidu_q2", provider: "vidu" },
  { id: "lovart-gemini-omni-flash", label: "Gemini Omni Flash", tool: "generate_video_gemini_omni_flash", provider: "gemini" },
];
...
async function pollLovartThread(threadId, { timeoutMs, autoConfirm, onStatus }) {
    ...
    if (state === "done") {
      ...
      if (result?.pending_confirmation) {
        if (!autoConfirm || confirmedOnce) {
          throw new Error(
            `Lovart is waiting for a credit confirmation (thread ${threadId}). Re-run with autoConfirmCredits=true to approve the estimated cost.`,
          );
        }
        confirmedOnce = true;
