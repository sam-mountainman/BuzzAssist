    ...
    for (const [index, job] of jobs.entries()) {
      ...
      if (outputExists) {
        ...
        if (entry.status === "generated") {
          ...
          reusedCount += 1;
          results.push({ assetFile, sha256: outputSha256, reused: true });
          continue;
        }
        if (entry.status === "generating") {
          ...
          recoveredCount += 1;
          results.push({ assetFile, sha256: outputSha256, reused: true, recoveredAfterInterruption: true });
          continue;
        }
      ...
      try {
        ...
        await writeCheckpoint();
        generatedCount += 1;
        results.push({ assetFile, sha256: outputSha256, reused: false });
      } catch (error) {
