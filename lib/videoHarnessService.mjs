...
export function createVideoHarnessService(overrides = {}) {
  ...
  async function execute(projectDir, jobId, { reviewerTrustPath = "", retryFailedImages = false, invocation = null } = {}) {
  ...
  async function resume({ projectDir = process.cwd(), jobId, confirmed = false, reviewerTrustPath = "", retryFailedImages = false, invocation = null } = {}) {
