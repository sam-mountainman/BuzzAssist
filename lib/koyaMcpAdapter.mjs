...
export const KOYA_MCP_ACTIONS = Object.freeze([
  "contract", "channel-contract", "character-bootstrap-status", "character-roster-review-draft", "character-roster-audit", "cast-readiness", "story-review-draft", "story-audit", "location-plan", "location-generate", "location-import", "location-anchor-review-draft", "location-anchor-audit", "location-review-draft", "location-register", "asset-quality-references", "thumbnail-plan-draft", "thumbnail-audit", "handoff-export", "handoff-verify", "handoff-restore", "wardrobe-readiness", "plan", "images", "character-review-refresh", "character-candidate-migrate-blind", "character-candidate-import", "character-candidate-qa-sheet", "character-style-generate", "character-style-import", "character-style-qa-sheet", "character-style-review-refresh", "character-style-record-failure", "character-style-compose", "character-style-select", "character-approve", "character-identity-refresh", "character-register",
...
const OPTION_NAMES = Object.freeze([
  ...
  "storyReviewPath", "rosterReviewPath", "wardrobeReviewPath", "wardrobeReadinessOverrideReason", "thumbnailPlanPath", "locationId", "locationStage", "locationAnchorReviewPath", "locationReviewPath", "importMapPath", "model",
  "layout",
