...
// Route priority for a family's default: free/local first, then Lovart before
// BuzzAssist so agent/user route choices match the visible route menu.
export const ROUTE_PRIORITY = ["codex", "hermes", "lovart", "buzzassist"];
